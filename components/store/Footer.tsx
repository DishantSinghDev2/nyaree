  ...
  return (
    <footer style={{ background: "var(--color-ink)", color: "rgba(255,255,255,0.7)" }}>
      ...
      <div className="container" style={{ padding: "64px 0 48px", display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 40 }}>
        ...
        <div>
          ...
          <div style={{ marginTop: 24 }}>
            <p style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", marginBottom: 10, letterSpacing: 1, textTransform: "uppercase" }}>We Accept</p>
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              {["UPI", "Visa", "Mastercard", "RuPay", "COD"].map((p) => (
                <span key={p} style={{ background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.15)", padding: "3px 8px", borderRadius: 2, fontSize: 10, color: "rgba(255,255,255,0.6)", letterSpacing: 0.5 }}>
                  {p}
                </span>
              ))}
            </div>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)" }}>
        <div className="container" style={{ padding: "20px 0", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          <p style={{ fontSize: 12, color: "rgba(255,255,255,0.35)" }}>
            © {year} Nyaree. All rights reserved. | Founder: Rishika Singh
          </p>

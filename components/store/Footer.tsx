...
const SOCIAL = [
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/shopnyaree",
    icon: (
      <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@shopnyaree",
    icon: (
      <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Pinterest",
    href: "https://pinterest.com/shopnyaree",
    icon: (
      <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <a href="mailto:hello@shopnyaree" style={{ fontSize: 13, color: "var(--color-gold)", textDecoration: "none" }}>hello@shopnyaree</a>

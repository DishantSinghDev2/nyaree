  ...
  return (
    <div className="container" style={{ maxWidth: 800, padding: "64px 0 80px" }}>
      ...
      <div className="prose">
        ...
        <p>By accessing and using Nyaree (nyaree.in), you accept and agree to be bound by these Terms of Service. If you do not agree, please do not use our website.</p>
        ...
        <p>All content on nyaree.in including images, text, and designs are the property of Nyaree and protected by copyright law. You may not reproduce or use our content without written permission.</p>
        ...
        <h2>11. Contact</h2>
        <p>Questions? Contact us at hello@nyaree.in or +91 8368989758.</p>
      </div>
    </div>
  );
}
